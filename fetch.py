...
from utils import download_file, get_example_input_from_html, read_file_to_string, write_string_to_file
...
def download_day(year, day):
    ...
    if not (file_path / 'test_input.txt').exists():
        ...
        example_input = get_example_input_from_html(read_file_to_string( file_path / 'puzzle.html'))
        if example_input:
